...
--
-- Name: elements name_const_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT name_const_unique UNIQUE (name);
...
--
-- Name: elements symbol_const_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_const_unique UNIQUE (symbol);
